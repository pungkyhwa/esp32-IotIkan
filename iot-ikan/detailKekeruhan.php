        ...
        <div class="w-full mx-auto bg-white shadow-lg rounded-lg overflow-hidden flex flex-col flex-grow">
            ...
            <div class="p-4 space-y-4 flex-grow">
                <?php 
                    ...
                    $query1 = "SELECT * FROM t_sensor where id_user = '$id_user' and id_sensor = '3' ORDER BY `t_sensor`.`tgl` DESC limit 1";
                ...
                <div class="space-y-2">
                <?php 
                    $query = "SELECT * FROM t_sensor where id_user = '$id_user' and id_sensor = '3' ORDER BY `t_sensor`.`tgl` ASC  ";
                    ...
                    foreach ($data as $row) {
                        ...
                        echo '<span>'.$tgl.'</span>';
                        echo '<i class="fas fa-water text-blue-600"></i>';
